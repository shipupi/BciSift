...
# Project:  BciSift.pro
# Template: app
# Command: /Users/rramele/Qt/5.11.1/clang_64/bin/qmake -o Makefile BciSift.pro -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../opencv/include -I/usr/local/include -I../kfr/include -I../labstreaminglayer/build/install/LSL/include -I../vlfeat -I../../Qt/5.11.1/clang_64/lib/QtCore.framework/Headers -I. -I../../Qt/5.11.1/clang_64/mkspecs/macx-clang -F/Users/rramele/Qt/5.11.1/clang_64/lib
QMAKE         = /Users/rramele/Qt/5.11.1/clang_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /Users/rramele/Qt/5.11.1/clang_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /Users/rramele/Qt/5.11.1/clang_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk -mmacosx-version-min=10.9 -Wl,-rpath,@executable_path/Frameworks -Wl,-rpath,/Users/rramele/Qt/5.11.1/clang_64/lib
LIBS          = $(SUBLIBS) -F/Users/rramele/Qt/5.11.1/clang_64/lib -L/usr/local/lib -L/Users/rramele/work/labstreaminglayer/build/install/LSL/lib/ -L/Users/rramele/work/vlfeat/bin/maci64/ -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_features2d -lopencv_xfeatures2d -lopencv_calib3d -lopencv_imgcodecs -lopencv_ml -lopencv_flann -llsl64 -lvl -framework QtCore -framework DiskArbitration -framework IOKit 
...
Makefile: BciSift.pro ../../Qt/5.11.1/clang_64/mkspecs/macx-clang/qmake.conf ../../Qt/5.11.1/clang_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.11.1/clang_64/mkspecs/qdevice.pri \
		../../Qt/5.11.1/clang_64/mkspecs/features/device_config.prf \
		../../Qt/5.11.1/clang_64/mkspecs/common/unix.conf \
		../../Qt/5.11.1/clang_64/mkspecs/common/mac.conf \
...
moc_predefs.h: ../../Qt/5.11.1/clang_64/mkspecs/features/data/dummy.cpp
	/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++ -pipe -stdlib=libc++ -g -std=gnu++1y $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk -mmacosx-version-min=10.9 -Wall -W -dM -E -o moc_predefs.h ../../Qt/5.11.1/clang_64/mkspecs/features/data/dummy.cpp
...
dsp.o: dsp.cpp ../kfr/include/kfr/base.hpp \
		...
		../kfr/include/kfr/cpuid/cpuid_auto.hpp \
		../kfr/include/kfr/cpuid/cpuid.hpp \
